...
<!-- TODO: Add documentation about anything specific to running your pipeline. -->
...
```bash
nextflow run U-BDS/nf_xenium_analysis --input ./samplesheet.csv --outdir ./results  -profile docker
```
...
```bash
nextflow pull U-BDS/nf_xenium_analysis
```
