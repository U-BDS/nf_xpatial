...
workflow CLUSTER_QC {
    take:
        ...
        skip_umap_dim_plot         // bool: whether to skip the UMAP dim plot with contours
        skip_split_cluster_plots   // bool: whether to skip the split cluster plots
        skip_marker_vln_plot       // bool: whether to skip the marker violin plots
        skip_marker_dot_plot       // bool: whether to skip the marker dot plots
